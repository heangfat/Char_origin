...
冓 = {"⿰":2,"⿲":3,"⿱":2,"⿳":3,"⿴":2,"⿵":2,"⿶":2,"⿷":2,"⿸":2,"⿹":2,"⿺":2,"⿻":2,"⿼":2,"⿽":2,"⿾":1,"⿿":1,"４":4,"５":5,"Ｔ":3,"Ｙ":3,"Ａ":1,"＋":1,"Ｗ":4}
挪用歸并件 = ["戶戸","辛⾟"]# 倒〬三角頭飾
挪用反倒轉件 = ["阜阝","舟⾈","水⽔","弓⼸","矢⽮","臣⾂"]# 雋之弓、受之舟、臦之反臣、益之水、射之矢
歸并件 = ["一●乛","囗〇","冈网","尞㶫","厂丆","上丄","下丅","凵𠙴","朩汖","兕𤉡","中𠁩","且𠀃","卣㔽","乂㐅","乙𠃉","几𠘧","冉冄","田龱","首𦣻","囟𡿺","眉𦭝","子㜽","垂𠂹","壼𡆵","井丼","申电","卩㔾","角甪","𫢉佘","于亐"]+ 挪用歸并件
