...
\hypersetup{colorlinks=true, citecolor=靛青}
...
\xeCJKsetup{PunctFamily=puncts, CJKecglue=\null, underwave={depth=0.5em,format=\color{赤}},underline={depth=0.5em,format=\color{赤},thickness=3\ULthickness}}% 標點字型fangsung，漢字與西文、符號之間隔，左畫綫去字遠近
